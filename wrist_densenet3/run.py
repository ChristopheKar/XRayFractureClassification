...
def create_fclayer(base_model, nb_classes=1, activation='relu'):
...
def run_MURA(batch_size,
    ...
    X_valid_path, Y_valid = data_loader.load_path(root_path = '../../val', size = im_size)
    ...
    predictions = create_fclayer(base_model, nb_classes, 'relu')
